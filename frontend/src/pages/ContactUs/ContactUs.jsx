  ...
  <div class="hidden md:block w-full md:w-auto" id="menu">
    <nav
      ...
      <ul class="md:flex items-center">
        ...
        <li class="md:ml-4"><Link class="text-xl py-2 inline-block md:text-white md:px-2 font-semibold border-b-8 border-transparent hover:border-white" to="/contact">Contact
            Us</Link></li>
    ...
    <div class="w-full fixcont:w-full sm:w-1/4 lg:w-5/12 lg:mx-2 lg:pr-8">
    ...
    <ul class="mt-4 contactinglist text-xl">
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="https://www.google.com/maps?ll=19.023716,72.856547&z=14&t=m&hl=en&gl=IN&mapclient=embed&cid=8343284557969155606" target="_blank" rel="noreferrer noopener" title="">
                <svg display="inline" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
                  <path
            ...
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="mailto:vjtiracingindia@me.vjti.ac.in" target="_blank" rel="noreferrer noopener" title="">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
                  <path
                    d="M20,4H4C2.896,4,2,4.896,2,6v12c0,1.104,0.896,2,2,2h16c1.104,0,2-0.896,2-2V6C22,4.896,21.104,4,20,4z M20,8.7l-8,5.334 L4,8.7V6.297l8,5.333l8-5.333V8.7z" />
                </svg>
                Email: <i>vjtiracingindia@me.vjti.ac.in</i>
              </a>
            </li>
            ...
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="mailto:vjtiracingindia@gmail.com" target="_blank" rel="noreferrer noopener" title="">
              ...
              Alternate Email: <i>vjtiracingindia@gmail.com</i>
              </a>
            </li>
            ...
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="tel:8828186508" target="_blank" rel="noreferrer noopener" title="">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
                  <path
            ...
            <br/>
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="mailto:pgpandit_b19@me.vjti.ac.in" target="_blank" rel="noreferrer noopener" title="">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current">
                  <path
                    d="M20,4H4C2.896,4,2,4.896,2,6v12c0,1.104,0.896,2,2,2h16c1.104,0,2-0.896,2-2V6C22,4.896,21.104,4,20,4z M20,8.7l-8,5.334 L4,8.7V6.297l8,5.333l8-5.333V8.7z" />
                </svg>
            ...
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="tel:8433547886" target="_blank" rel="noreferrer noopener" title="">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current ">
                  <path
            ...
            <li class="ml-6 opacity-75 hover:opacity-100">
              <a href="mailto:apniranjan_b19@me.vjti.ac.in" target="_blank" rel="noreferrer noopener" title="">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="fill-current ">
                  <path
    ...
    <div class="w-full sm:w-2/3 lg:w-2/3 lg:mx-2 lg:pr-8 pt-5 sm:pt-0">
        <iframe title="Google Form for Contacting Us" src="https://docs.google.com/forms/d/e/1FAIpQLSfbvzXopTyWtSJzy16c7yBZ1Lm8ipdwGQcdP0mTItQdkQ_p0g/viewform?embedded=true" width="100%" height="1600" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
    </div>
    </div>
    </section>
