    ...
    <section class="relative bg-gray-900 text-center text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-16 lg:py-32">
      <div class="flex flex-col lg:flex-row lg:-mx-8">
        <div class="w-full lg:w lg:px-8">
          <h2 class="text-4xl leading-tight font-bold mt-4 pt-10">Our Team</h2>
          <br/>
          <p class="mt-2 leading-relaxed text-white pb-0 mb-0 text-xl">
          <blockquote className="relative p-4 text-xl italic  quote">
...
❝
  ...
  <cite className="text-right">
    <span className="mb-1 text-sm italic font-bold text-right">
      - Heler Keller
    </span>
  </cite>
</blockquote>
    ...
    <section class="relative bg-gray-100 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-8 lg:pt-16">
      <div class="flex flex-col lg:flex-row lg:-mx-8">
        <div class="w-full">
          <h2 class="text-3xl leading-tight font-bold mt-4">Our Team This Year</h2>
        </div>
